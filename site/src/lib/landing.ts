export const landingCopy = {
  en: {
    ...
    statusBody: "Rationale is in public beta. The core and full capture/review cycle are functional; platform coverage, pilot gates and human review remain visible work.",
    statusAlpha: "public beta / latest",
    statusEvidence: "Current public release: latest",
    statusOpen: "Open: platform matrix, provider coverage and pilot gates.",
    ...
    installStep4: "04 / Restart the agent and verify Rationale health.",
  ...
  es: {
    ...
    statusBody: "Rationale está en beta pública. El núcleo y el ciclo completo de captura/revisión son funcionales; la cobertura de plataformas, los gates del piloto y la revisión humana siguen visibles.",
    statusAlpha: "beta pública / latest",
    statusEvidence: "Release pública actual: latest",
    statusOpen: "Abierto: matriz de plataformas, cobertura del proveedor y gates del piloto.",
    ...
    installStep4: "04 / Reinicia el agente y verifica la salud de Rationale.",
