...
- `RATIONALE_VERSION=v0.1.0-alpha.4` fija una versión concreta (sustitúyela
...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/Ragosorio/Rationale/releases/download/v0.1.0-alpha.4/rationale-update.sh | sh
```
